...
def launch_setup(context, *args, **kwargs):      
    ...
    return [
        ...
        # DeclareLaunchArgument('rgbd_optimize_max_error',  default_value=LaunchConfiguration('rgbd_optimize_max_error'), description='Max Error for optimization.'),
        ...
        Node(
            ...
            parameters=[{
                ...
                # "rgbd_optimize_max_error": LaunchConfiguration('rgbd_optimize_max_error'),
            }],
            remappings=[
                ...
                # ("RGBD/OptimizeMaxError", LaunchConfiguration('rgbd_optimize_max_error'))
            ],
...
def generate_launch_description():
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('approx_sync_max_interval',  default_value='0.01', description='(sec) 0 means infinite interval duration (used with approx_sync=true)'),

        # DeclareLaunchArgument('rgbd_optimize_max_error',  default_value='8.0', description='(s)'),
