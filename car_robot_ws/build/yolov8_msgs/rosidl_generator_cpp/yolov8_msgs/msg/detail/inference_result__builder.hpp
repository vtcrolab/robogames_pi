...
class Init_InferenceResult_depth
{
public:
  explicit Init_InferenceResult_depth(::yolov8_msgs::msg::InferenceResult & msg)
  : msg_(msg)
  {}
  ::yolov8_msgs::msg::InferenceResult depth(::yolov8_msgs::msg::InferenceResult::_depth_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_InferenceResult_depth right(::yolov8_msgs::msg::InferenceResult::_right_type arg)
  {
    msg_.right = std::move(arg);
    return Init_InferenceResult_depth(msg_);
  }
