...
#include "yolov8_msgs/msg/detail/color_detection__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yolov8_msgs::msg::ColorDetection & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: color_detected
  cdr << ros_message.color_detected;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yolov8_msgs::msg::ColorDetection & ros_message)
{
  // Member: color_detected
  cdr >> ros_message.color_detected;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_yolov8_msgs
max_serialized_size_ColorDetection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolov8_msgs::msg::ColorDetection;
    is_plain =
      (
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_yolov8_msgs
max_serialized_size_key_ColorDetection(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
...
{
  auto typed_message =
    static_cast<const yolov8_msgs::msg::ColorDetection *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yolov8_msgs::msg::ColorDetection *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _ColorDetection__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const yolov8_msgs::msg::ColorDetection *>(
...
static size_t _ColorDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_ColorDetection(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _ColorDetection__callbacks = {
  "yolov8_msgs::msg",
  "ColorDetection",
...
static rosidl_message_type_support_t _ColorDetection__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_ColorDetection__callbacks,
...
{
  return &yolov8_msgs::msg::typesupport_fastrtps_cpp::_ColorDetection__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yolov8_msgs, msg, ColorDetection)() {
  return &yolov8_msgs::msg::typesupport_fastrtps_cpp::_ColorDetection__handle;
}
